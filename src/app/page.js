...
export default function Home() {
  ...
  return (
    <div >
      ...
      <div class="min-w-screen h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover" style={{
        ...
        <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
          ...
          <div className={statecode === 0 ? 'hidden' : 'block'}>
            ...
            <div class="text-center p-5 flex-auto justify-center">
              ...
              <h2 class="text-xl font-bold py-4 ">Registro Exitoso</h2>
              <p class="text-sm text-gray-500 px-8">Bienvenido {user.email}</p>
            </div>

            <div class="p-3  mt-2 text-center space-x-4 md:block">
              <button onClick={handleLogout} class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100">
                Cerrar Sesion
              </button>
          ...
          <div className={statecode === 1 ? 'hidden' : 'block'}>
            ...
            <div class="text-center p-5 flex-auto justify-center">
              ...
              <h2 class="text-xl font-bold py-4 ">Activacion de cuenta</h2>
              <p class="text-sm text-gray-500 px-8">Bienvenido {user.email}</p>
            </div>
